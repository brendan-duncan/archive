...
void main() {
  group('crc32', () {
    test('empty', () {
      final crcVal = getCrc32List([]);
      expect(crcVal, 0);
    });
    test('1 byte', () {
      final crcVal = getCrc32List([1]);
      expect(crcVal, 0xA505DF1B);
    });
    test('10 bytes', () {
      final crcVal = getCrc32List([1, 2, 3, 4, 5, 6, 7, 8, 9, 0]);
      expect(crcVal, 0xC5F5BE65);
    });
    test('100000 bytes', () {
      var crcVal = getCrc32List([]);
      for (var i = 0; i < 10000; i++) {
        crcVal = getCrc32List([1, 2, 3, 4, 5, 6, 7, 8, 9, 0], crcVal);
      }
