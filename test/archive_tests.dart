...
import 'input_stream_file_test.dart' as input_stream_file_test;
import 'input_stream_memory_test.dart' as input_stream_memory_test;
//import 'tests/io_test.dart' as io_test;
import 'output_stream_file_test.dart' as output_stream_file_test;
import 'output_stream_memory_test.dart' as output_stream_memory_test;
...
void main() {
  ...
  //gzip_test.main();
  //inflate_test.main();
  input_stream_file_test.main();
  input_stream_memory_test.main();
  //io_test.main();
  output_stream_file_test.main();
  output_stream_memory_test.main();
  //tar_test.main();
  zip_test.main();
  zlib_test.main();
  //xz_test.main();
